    ...
    >
      <section id="projects">
        ...
        <Card
          title={"POV Maze"}
          body={
            "POVMAZE is a game built in just 7 days using React, Phaser, and Firebase. The project began as a 2D version of Pacman, but over the course of the week, the team expanded it into a fully-realized 3D maze runner with raycasting. The game is designed to be played from a first-person point of view, immersing the player in the game world. One of the key features of the game is the use of raycasting, a technique that simulates the behavior of light rays to create 3D graphics in real-time. This allows for realistic rendering of the maze and its surroundings, and creates a more immersive experience for the player."
          }
